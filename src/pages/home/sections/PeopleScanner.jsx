...
const PeopleScanner = () => {
  return (
    <div className="container  mx-auto flex flex-wrap justify-around items-start gap-4 py-8">
      <div className="background-image flex justify-start rounded-[32px] items-center bg-[url('/gym_man.jpg')] bg-cover w-[30%] h-[480px] relative">
        <img
          src={Images.Mask}
          alt="Background"
      ...
      <div className="people-scan-detail w-[38%]  flex flex-col gap-6">
        ...
        <div className="description">
          <small className="text-gray-300 text-[18px]">
